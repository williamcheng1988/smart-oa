...
//		setPagination(department);
//		// 得到分页结果
//		departments = roleBiz.listRole(department);
//		// 封装数据
//		dataGrid = new DataGrid(roleBiz.listRoleCount(department), roles);
//		return DATA_GRID;
//	}
//
//	/**
...
//		if(roleId != null){
//			department = roleBiz.findRole(roleId[0]);
//			checkedResource(resources, department.getResourceIds());
//		}
...
//			allowRoleFile.setRoleId(Integer.valueOf(department.getRoleId()));  // 根据登录获取用户角色ID
...
//		// 检查名称是否重复
//		Role tmpRole = roleBiz.findRoleByName(department.getRoleName()); 
//		if (tmpRole != null) {
...
//		department.setCreateUser(loginStaff.getLoginName());
//		department.setDataType(dataTypeHid);
//		String id = "";
//		try {
//			// 增加角色
//			String[] array = null;
...
//			id = roleBiz.insertRole(department,array);
//			
//			
//			// 不允许查看的文件类型
...
//			
//		} catch (Exception e) {
//			operateLogBiz.info(OperateLogType.ROLE_MANAGE,roleId.toString(),department.getRoleName(), "新增失败");
//			throw e;
//		}
//		operateLogBiz.info(OperateLogType.ROLE_MANAGE,id,department.getRoleName(), "新增成功");
...
//		// 检查名称是否重复
//		Role tmpRole = roleBiz.findRoleByName(department.getRoleName());
//		if (tmpRole != null&& !tmpRole.getRoleId().equals(department.getRoleId())) {
//			operateResult = new OperateResult(-1, "角色名称己存在!");
//			return OPER_RESULT;
//		}
//		Staff loginStaff = getLoginStaff();
...
//			if(resourceIds != null)
//				array = resourceIds.split(",");
//			roleBiz.updateRole(department, array);
//			
//			
//			// 修改不允许查看的文件类型
//			String[] unAllowArr = null;
...
//				unAllowArr = unAllowFiles.split(",");
//				RoleFiletype urf = new RoleFiletype();
//				urf.setRoleId(Integer.valueOf(department.getRoleId()));
//				urf.setIsSee(2);  // 不可看
//				roleFiletypeBiz.batchSaveUpdate(unAllowArr, urf);
//			}
//			
//		} catch (Exception e) {
//			operateLogBiz.info(OperateLogType.ROLE_MANAGE, String.valueOf(department.getRoleId()),String.valueOf(department.getRoleName()), "修改失败");
//			throw e;
//		}
//		// 调用列表方法
//		department = new Role();
//		operateLogBiz.info(OperateLogType.ROLE_MANAGE, String.valueOf(department.getRoleId()),String.valueOf(department.getRoleName()), "修改成功");
