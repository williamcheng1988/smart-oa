...
public class EmailHelper
{
     ...
     */
    private static void setAttachment(MultiPartEmail email, EmailMessage emailMessage)
        throws Exception
    {
     ...
     * @throws EmailSendException 邮件发送异常
     */
    private static void setEmail(Email email, EmailMessage emailMessage)
        throws Exception
    {
        try
        {
            ...
            // 设置认证信息
            email.setAuthentication(xmlConfiguration.getString("user-name"), xmlConfiguration.getString("password"));
            ...
            else
            {
                ...
                email.setFrom(xmlConfiguration.getString("default-from"),
                    xmlConfiguration.getString("default-from-alias"),
                    charset);
            }
