...
public class DesThirdKey {

    private String firstKey;
    private String secondKey;
    private String thirdKey ;
    
    public DesThirdKey( String firstKey, String secondKey,  String thirdKey) {
    ...
    public static void main(String[] args) {
        ...
        String key2 = "222";
        String key3 = "33";
        DesThirdKey ttt = new DesThirdKey(key1,key2,key3);
       
        String data = "1DERom我们";
        String str = ttt.strEnc(data);
        System.out.println(str);
        String dec = ttt.strDec(str);
